...
while (True):
	...
	if(Menu == "C"):
		while(True):
			...
			Person.ID = ReadInt()
			print("\nNombres:\n")
			Person.Name = ReadChar()
			print("\nApellidos:\n")
			Person.LastName = ReadChar()
			print("\nAhorros:\n")
			Person.Savings = ReadDecimal()
			Person.Data = F_Encode()
			Person.Password = ReadPassword()

			if(ID_Exist(str(Person.ID))):
					...
					if(Option == "A"):
						...
						if(Grabar == "Y"):
							with open(sys.argv[1], "a") as writer:
								writer.write(Person.ID + "," + 	Person.Name + "," + Person.LastName + "," + Person.Savings + "," + Person.Password + "," + str(Person.Data) + "\n")
						elif(Grabar == "N"):
							continue
					elif(Option == "S"):
						print("\nSaliendo del programa...\n")
		...
		while(True):
			...
			NewPerson = NewPerson()
			print("\nCédula:\n")
			NewPerson.ID = ReadInt()
			print("\nNombres:\n")
			NewPerson.Name = ReadChar()
			print("\nApellidos:\n")
			NewPerson.Name = ReadChar()
			print("\nAhorros:\n")
			NewPerson.Savings = ReadDecimal()
			NewPerson.Data = F_Encode()
			NewPerson.Password = ReadPassword()

			NewVals = (NewPerson.ID + "," + NewPerson.Name + "," + NewPerson.LastName + "," + NewPerson.Savings + "," + NewPerson.Password + "," + str(NewPerson.Data) + "\n")

			if(ID_Exist(str(NewPerson.ID))):
				print("\n¡Cédula existente!\n\nFavor ingresar cédula correcta...\n")
			else:
