...
while (True):
	...
	if(Menu == "C"):
					...
					if(Option == "A"):
						...
						if(Grabar == "Y"):
							with open(sys.argv[1], "a") as writer:
								writer.write(Person.ID + "," + 	Person.Name + "," + Person.Name + "," + Person.Savings + "," + Person.Password + "," + str(Person.Data) + "\n")
						elif(Grabar == "N"):
							continue
					elif(Option == "S"):
						print("\nSaliendo del programa...\n")
		...
		while(True):
			...
			NewVals = (NewPerson.ID + "," + NewPerson.Name + "," + NewPerson.Name + "," + NewPerson.Savings + "," + NewPerson.Password + "," + str(NewPerson.Data) + "\n")
